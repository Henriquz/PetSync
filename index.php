            ...
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8">
                  <!--  <a href="./index.html" class="text-petGray hover:text-petBlue font-medium">Início</a> -->
                    <a href="./index.html" class="text-petGray hover:text-petBlue font-medium">Serviços</a>
                    <a href="./index.html" class="text-petGray hover:text-petBlue font-medium">Produtos</a>
                    <a href="./index.html" class="text-petGray hover:text-petBlue font-medium">Sobre</a>
                    <a href="./index.html" class="text-petGray hover:text-petBlue font-medium">Contato</a>
                    <a href="./login.html"
   class="inline-block px-4 py-1.5 bg-petOrange text-white text-sm font-semibold rounded-full shadow-md
          hover:bg-petBlue hover:shadow-lg transition-colors duration-300 ease-in-out
          focus:outline-none focus:ring-2 focus:ring-petBlue focus:ring-opacity-50">
  Entrar
</a>
                </div>
            ...
            <div id="mobile-menu" class="md:hidden hidden pt-4 pb-2">
                ...
                <a href="./index.html" class="block py-2 text-petGray hover:text-petBlue font-medium">Serviços</a>
                <a href="./index.html" class="block py-2 text-petGray hover:text-petBlue font-medium">Produtos</a>
                <a href="./index.html" class="block py-2 text-petGray hover:text-petBlue font-medium">Sobre</a>
                <a href="./index.html" class="block py-2 text-petGray hover:text-petBlue font-medium">Contato</a>
                <a href="./login.html"
   class="block w-full py-2 bg-petOrange text-white text-center text-base font-semibold rounded-md
          hover:bg-petBlue hover:text-white transition-colors duration-300 ease-in-out
          focus:outline-none focus:ring-2 focus:ring-petBlue focus:ring-opacity-50">
  Acessar sua Conta
</a>
            </div>
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-10 md:mb-0">
                    ...
                    <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        <a href="./index.html" class="bg-petOrange hover:bg-orange-600 text-white font-medium py-3 px-6 rounded-lg text-center transition duration-300">Nossos Serviços</a>
                    ...
                    <!-- Imagem nova à direita -->
                      ...
                      <div class="relative">
                        ...
                        <div class="absolute -bottom-6 -right-6 w-24 h-24 bg-petBlue rounded-full opacity-20"></div>
                              <img src="Imagens/PetSync-dog.jpeg" class="w-[300px] h-auto rounded-lg" />
                      </div>
                    </div>
    ...
    <section id="products" class="py-16 bg-petLightGray bg-opacity-30">
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mt-12">
                <a href="./index.html" class="inline-flex items-center bg-petBlue hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition duration-300">
                        ...
                        <div class="bg-petLightGray rounded-lg p-6 relative z-10">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="bg-white rounded-lg p-4 shadow-md">
                                    <div class="text-4xl text-petOrange font-bold mb-2">1+</div>
                                ...
                                <div class="bg-white rounded-lg p-4 shadow-md">
                                    <div class="text-4xl text-petBlue font-bold mb-2">15+</div>
...
<section id="contact" class="py-16 bg-white">
  <div class="container mx-auto px-4">
    <div class="w-full">
      <div class="bg-petLightGray bg-opacity-30 p-8 rounded-lg text-center">
        
        <!-- Título com traço abaixo, centralizado -->
        <h2 class="text-3xl font-bold text-petGray mb-2">
          Entre em <span class="text-petOrange">Contato</span>
        </h2>
        <div class="w-24 h-1 bg-petBlue mx-auto mb-8"></div>

        <!-- Linha com os 3 blocos: Telefone | Email | Horário -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 justify-items-center gap-8">  
          ...
          <div class="flex flex-col items-center text-center max-w-xs">
            <div class="w-16 h-16 bg-petBlue bg-opacity-20 rounded-full flex items-center justify-center mb-4">
              <svg class="w-8 h-8 text-petBlue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex flex-col items-center text-center max-w-xs">
            <div class="w-16 h-16 bg-petOrange bg-opacity-20 rounded-full flex items-center justify-center mb-4">
              <svg class="w-8 h-8 text-petOrange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <div class="flex flex-col items-center text-center max-w-xs">
            ...
            <p class="text-petGray">Segunda a Sexta: 8h às 18h</p>
            <p class="text-petGray">Sábado: 8h às 12h</p>
    ...
    <!-- Map Section -->
<section class="py-8 bg-petLightGray bg-opacity-30">
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white p-4 rounded-lg shadow-lg">
            <div class="bg-petLightGray rounded-lg overflow-hidden">
                <iframe 
                    ...
                    loading="lazy"
                    allowfullscreen
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3777.272812402813!2d-42.14530288511964!3d-19.78967638666414!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xbcbbd55c177bff%3A0x9b5c5a137bb0a1a1!2sR.%20Jo%C3%A3o%20Pinheiro%2C%20147%20-%20Centro%2C%20Caratinga%20-%20MG%2C%2035300-048!5e0!3m2!1spt-BR!2sbr!4v1717100000000!5m2!1spt-BR!2sbr">
                </iframe>
                <div class="text-center py-4">
                    <p class="text-petGray text-lg">R. João Pinheiro, 147, Sala 214 - Centro, Caratinga - MG</p>
                </div>
            </div>
        </div>
    </div>
